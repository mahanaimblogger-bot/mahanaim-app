      ...
      <div className="max-w-[922px] mx-auto px-0 pb-10">
        <div className="bg-[#fdfbf7] p-5 border border-[#d4c4a8]">
          ...
          {Object.entries(secciones).map(([nombreSeccion, slugs]) => (
            <div
              key={nombreSeccion}
              className="mb-8 p-4 bg-white rounded-lg border-l-4 border-[#8d6e63] shadow-sm"
            >
              <h2 className="text-[#bf360c] text-xl font-bold border-b border-gray-200 pb-2 mb-4">
                {nombreSeccion}
              </h2>
        ...
        {/* Footer */}
        <footer className="text-center py-5 text-sm text-[#8d6e63] border-t border-[#d4c4a8] font-['Georgia',serif]">
